...
% ermöglicht mehr Zeichen in Matheformeln, zB das Grad-Symbol: °
\usepackage{gensymb}
...
% hiermit kann die Verschachtelungstiefe des Inhaltsverzeichnisses angepasst werden
\setcounter{tocdepth}{4}

% erlaubt Unter-Unter-Kapitel
\setcounter{secnumdepth}{4}
\newcommand{\subsubsubsection}[1]{\paragraph{#1}\mbox{}\\}

% Indent des Inhaltsverzeichnisses
\usepackage{tocloft}
\cftsetindents{section}{0cm}{0.5cm}
\cftsetindents{subsection}{0.5cm}{1.0cm}
\cftsetindents{subsubsection}{1cm}{1.5cm}
\cftsetindents{paragraph}{1.5cm}{2cm}
...
\input{ListeAllerUnterdokumente.tex}
\newpage
